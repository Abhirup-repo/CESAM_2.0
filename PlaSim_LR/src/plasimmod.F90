...
!      integer :: nud  = 6  ! plasim_diag 
      integer :: nud  = 8  ! plasim_diag; FO: do not hijack stdout 
      integer :: nutc = 61 ! plasim_time_control
...
!     additional filenames for time control SiS
      character (256) :: plasim_time_control = "plasim_time_control"
...
!     ***************
      ...
      integer :: nstep2          =       0 ! record counter for storage !SiS
      integer :: nstep3          =       0 ! record counter for storage !AB
      integer :: nstepe          =       0 ! end timestep for this run  !SiS
...
!     ***********************
      ...
      !**************************
!     * Nuddging and observation parameters *
!     **************************
      ! guokun added nudging coefficient
      real :: dnudg(NLEV)    =  0. ! nudging time scale for divergence  [days]
      real :: tnudg(NLEV)    =  0. ! nidging time scale for temperature [days
      real :: znudg(NLEV)    =  0. ! nudging time scale for vorticity [days
      real :: qnudg(NLEV)    =  0. ! nudging time scale for sp huminidity [days
...
!     *************
      ...
      real :: dalb(NHOR)      = 0.     ! albedo
      real :: dswfl(NHOR,NLEP)= 0.     ! net solar radiation
      real :: dlwfl(NHOR,NLEP)= 0.     ! net thermal radiation
      real :: dflux(NHOR,NLEP)= 0.     ! net radiation (SW + LW)
      real :: dfu(NHOR,NLEP)  = 0.     ! solar radiation upward
      real :: dfd(NHOR,NLEP)  = 0.     ! solar radiation downward
      real :: dftu(NHOR,NLEP) = 0.     ! thermal radiation upward
      real :: dftd(NHOR,NLEP) = 0.     ! thermal radiation downward
...
!     *********
      ...
      real :: dprc(NHOR) = 0.   ! Convective Precip   (m/s)
      real :: dprl(NHOR) = 0.   ! Large Scale Precip  (m/s)
      real :: dprs(NHOR) = 0.   ! Snow Fall           (m/s)
      real :: dqvi(NHOR) = 0.   ! vertical integrated specific humidity (kg/m**2)
...
!     **********************************************
      ...
      character(len=80) :: plasimversion = "https://github.com/Edilbert/PLASIM/ : 12-Jun-2014"
