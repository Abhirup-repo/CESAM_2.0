...
!      print *, "Calling outini"
      ...
      !print *, "nstep value in outini",nstep
...
!     planet properties to the postprocessor "burn"
      ...
      write (40) zsig(:)
      !print *, "Calling outini"
      !print *, "the header in outini", ihead(:)
     return
      end
!      print *, "the header in outini", ihead(:)
!     ==================
...
!      print *, "nstep in writegp",nstep

      !      print *, "The header file in writegp",ihead(:)
...
!     ==================
      ...
      ihead(7) = nstep - nstep1
      ihead(8) = n_days_per_year
      !print *, "the value of nstep in writesp",nstep
      !print *, "the value of nstep1 in writesp",nstep1
