...
!$TAF SUBROUTINE gp2fc ADNAME  = gp2fc_adj
...
!$TAF SUBROUTINE fc2gp ADNAME  = fc2gp_adj
!$TAF SUBROUTINE fc2gp FTLNAME  = fc2gp

!     ====================
!     SUBROUTINE GP2FC_ADJ
!     ====================

      subroutine gp2fc_adj(a,n,lot)
      use fftmod
      use pumamod, only : NTP1
      real a(n,lot)

      a(1,:)=a(1,:)/real(n)
      a(2,:)=0.
      a(2*NTP1+1:,:)=0.       ! these are supposed to be zero
      a(3:n,:)=a(3:n,:)/real(n)/2.
...
!     ====================
!     SUBROUTINE FC2GP_ADJ
!     ====================

      subroutine fc2gp_adj(a,n,lot)
      use fftmod
      real a(n,lot)
