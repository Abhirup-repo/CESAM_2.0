...
! ad hoc fix to make the failing TAF-normalisation of this compilable, even if not used.
      if ( all( ip(1:NLAY) == 0 ) ) then
        return
      else
        do L=1,NLAY
          if(ip(L) .ne. 0) then
