...
!     surface definitions
!
      real :: dts(NHOR)      = 0.  ! surface temperature (K)
      real :: dqs(NHOR)      = 0.  ! surface humidity    (kg/kg)
      real :: dsst(NHOR)     = 0.  ! sea surface temperature (K)
!
...
!!    for MIT coupling
      real :: cpsa(NHOR)     = 0.  ! surface pressure (Pa) (puma -> ice)
!!
