      ...
      integer            :: nsurnum                  ! total # of records
      integer, parameter :: nfreefo_default = 1      ! 1: free format
      character(len=16),parameter :: ysfile_default = 'surface.sra' ! surface file name
...
!     ======================
      ...
      integer :: nfreefo
      character (len=16) :: ysfile ! surface file name

      nsurnum  =   0             ! FO: better reset this if prolog is called from AD toplevel (wrapper)
      nfreefo = nfreefo_default  ! FO: better reset this if prolog is called from AD toplevel (wrapper)
      ysfile = ysfile_default    ! FO: better reset this if prolog is called from AD toplevel (wrapper)
